...
import { 
  ...
  MessageSquare, // Added for Quote Vault
  Lightbulb // Added for Idea Vault
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <style>{`
        ...
        /* Fix iPhone Safari styling issues */
        * {
        ...
        /* Fix card and button colors specifically for mobile */
        .glass-effect {
        ...
        /* Ensure consistent button and card styling on mobile */
